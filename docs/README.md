...
## � Quick Start: Executar Fluxos

**Novo?** Leia este guia passo a passo:

👉 **[FLOW_EXECUTION_GUIDE.md](FLOW_EXECUTION_GUIDE.md)** - Guia completo de como executar fluxos
...
### Para Iniciantes
- **[FLOW_EXECUTION_GUIDE.md](FLOW_EXECUTION_GUIDE.md)** - Passo a passo completo (como iniciar app, executar fluxos, tratamento de erros)
- **[QUICK_REFERENCE.md](QUICK_REFERENCE.md)** - Referência rápida de comandos
- **[FLOW_DOCUMENTATION_INDEX.md](FLOW_DOCUMENTATION_INDEX.md)** - Índice de toda documentação de fluxos

### Para Desenvolvedores
- **[FLOW_CODE_EXAMPLES.md](FLOW_CODE_EXAMPLES.md)** - Exemplos em Python, JavaScript, cURL
- **[QUICK_START.md](QUICK_START.md)** - Início rápido técnico

### Para Testers/QA
- **[FLOW_USE_CASES.md](FLOW_USE_CASES.md)** - 6 casos de uso práticos com testes automatizados
- **[EXAMPLES_API_CALLS.md](EXAMPLES_API_CALLS.md)** - Exemplos de requisições

### Referência Técnica
- **[FLOWS_DOCUMENTATION.md](FLOWS_DOCUMENTATION.md)** - Detalhes dos 6 fluxos de atendimento
...
│   │   └── flows.py          # Fluxos de atendimento (6 tipos)
│   ├── config.py             # Variáveis de ambiente
│   └── main.py               # Ponto de entrada FastAPI
├── data/
│   └── documents/            # Base de conhecimento (faqs.json)
